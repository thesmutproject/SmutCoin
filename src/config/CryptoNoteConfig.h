...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x16c997;
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 30; //30 blocks * 60 seconds = 30 mns
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(50000000000); //500m with the decimal of 2
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(2500000000); //1% dev team 4% private sale = 5% premine
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "011e01ff000180f28ba809029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101b673b16702d51a53b8cf49009c0f0e37e5a6d7dd02da3b0492d82e3d554cd07c";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1545316200; //Human time (GMT): Thursday, December 20, 2018 2:30:00 PM
...
const char     CRYPTONOTE_NAME[]                             = "SmutCoin";
...
{
    {  0x35, 0xe0, 0x5c, 0x3f, 0xff, 0xc6, 0x87, 0xf1, 0x1e, 0x5a, 0x37, 0xb6, 0x53, 0x1d, 0xd3, 0xf9  }
};
